...
$sql = "SELECT * FROM `adarsh college`.`admissionform` WHERE status = 'rejected'";
...
<body>
    <center><h1>REJECTED APPLICATIONS</h1></center>
        ...
        <div class="table-container" id="tableContainer">
            <table border="1" style="border-collapse: collapse; width: 70%; margin: 0 auto;">
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<tr><td colspan='3'>No rejected applications.</td></tr>";
                }
                ?>
            </table>
        </div>
