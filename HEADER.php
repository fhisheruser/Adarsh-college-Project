        ...
        <ul class="side-menu top">
            ...
            <li>
                ...
                <ul class="dropdown-menu reports">
                    ...
                    <li><a class="dropdown-item" href="event_report.php">Event Report</a></li>
            ...
            <li>
                <a href="trialform.php">
                    <i class="bx bxs-message-dots"></i>
                    <span class="text">Student Master</span>
                </a>
            </li>
            ...
            <li>
                <a href="event.php">
                    <i class="bx bxs-message-dots"></i>
                    <span class="text">Event Master</span>
                </a>
            </li>
            ...
            <li>
                <a href="transfer.php">
                    <i class="bx bxs-message-dots"></i>
                    <span class="text">Transfer Master</span>
                </a>
            </li>
